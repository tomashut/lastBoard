...
static CO_ERR   COTStringWrite(struct CO_OBJ_T *obj, struct CO_NODE_T *node, void *buffer, uint32_t size);
...
const CO_OBJ_TYPE COTString = { COTStringSize, COTStringInit, COTStringRead, COTStringWrite, COTStringReset };
