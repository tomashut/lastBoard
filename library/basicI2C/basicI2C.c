...
I2C_ERR basicI2C_ParamsInstall(st_i2cPhy* this, st_i2cConfig* config)
{
	...
	this->handlerI2C.Init.ClockSpeed 		= 100000;
	this->handlerI2C.Init.OwnAddress1 		= config->OwnAddress1;
	this->handlerI2C.Init.OwnAddress2 		= config->OwnAddress2;
	this->timeout							= config->timeout;
	//GPIO
	i2c_sclkConfig.enum_GPIO = config->sclk_GPIO;
	i2c_sdaConfig.enum_GPIO  = config->sda_GPIO;

	//SCLK
	i2c_sclkConfig.Pin		 = config->sclk_Pin;
	this->sclk_Pin.pin_config = &i2c_sclkConfig;
	//SDA
	i2c_sdaConfig.Pin		 = config->sda_Pin;
	this->sda_Pin.pin_config = &i2c_sdaConfig;
...
I2C_ERR basicI2C_MasterTransmit(st_i2cPhy* this)
{
...
I2C_ERR	basicI2C_MasterRreceive(st_i2cPhy* this)
{
...
{
	this->i2c_func.init 			 = basicI2C_Init			;
	this->i2c_func.transmit 		 = basicI2C_MasterTransmit	;
	this->i2c_func.receive 			 = basicI2C_MasterRreceive	;
	this->i2c_func.pin_init			 = &basicPin_Init			;
